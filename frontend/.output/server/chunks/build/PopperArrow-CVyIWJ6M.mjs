import { a0 as useForwardProps$1, W as useEmitAsProps, C as injectConfigProviderContext, Z as useForwardExpose, b as Primitive, k as createContext } from './server.mjs';
import { computed, ref, defineComponent, openBlock, createElementBlock, normalizeStyle, unref, createVNode, mergeProps, withCtx, renderSlot, watchPostEffect, createBlock, watchEffect, mergeDefaults } from 'vue';
