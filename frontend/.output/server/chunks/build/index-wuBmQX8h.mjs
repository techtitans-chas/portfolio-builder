import { av as useRoute, ac as useComponentProps, a8 as useAppConfig, a5 as tv, b as Primitive, e as _sfc_main$8, d as _export_sfc, j as _sfc_main$d } from './server.mjs';
import { u as usePrefix } from './usePrefix-DEbZTxVe.mjs';
import { _ as _sfc_main$5 } from './Container-BZ5KCJ-R.mjs';
import { _ as _sfc_main$4 } from './Alert-CsIjDkc0.mjs';
import { l as lo } from '../_/vue-draggable-plus.mjs';
import { _ as _sfc_main$6 } from './Card-EP3E58RR.mjs';
import { u as useApi } from './useApi-KjbfWxXr.mjs';
import { F as publicAssetsURL } from '../nitro/nitro.mjs';
import { o as vueExports, f as ssrRenderComponent_1, b as ssrRenderAttr_1, i as ssrRenderSlot_1, e as ssrRenderClass_1, a as ssrInterpolate_1, g as ssrRenderList_1, d as ssrRenderAttrs_1, j as ssrRenderStyle_1 } from '../routes/renderer.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.8.0_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_0c4e5d558bbbd0ce3bc597d918a8198d/node_modules/@nuxt/ui/dist/runtime/components/PageHero.vue");
...
const _imports_0 = publicAssetsURL("/media/hero-builder.svg");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_UPageHero, {
        ...
        title: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Build Your Next Project in Minutes`);
          } else {
            return [
              vueExports.createTextVNode("Build Your Next Project in Minutes")
            ];
          }
        }),
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="absolute inset-0 z-0 bg-sky-500 opacity-80 mix-blend-multiply"${_scopeId}></div><div class="absolute inset-0 z-0 bg-linear-to-br/oklch from-teal-500 from-30% to-sky-500 opacity-60"${_scopeId}></div><img${ssrRenderAttr_1("src", _imports_0)} alt="Website builder interface" class="rounded-lg relative z-10"${_scopeId}>`);
          } else {
            return [
              vueExports.createVNode("div", { class: "absolute inset-0 z-0 bg-sky-500 opacity-80 mix-blend-multiply" }),
              vueExports.createVNode("div", { class: "absolute inset-0 z-0 bg-linear-to-br/oklch from-teal-500 from-30% to-sky-500 opacity-60" }),
...
//# sourceMappingURL=index-wuBmQX8h.mjs.map
