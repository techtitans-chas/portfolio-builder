import { a9 as useAsyncData, aw as useRuntimeConfig, ap as useNuxtApp, ay as useState, am as useHead, j as _sfc_main$d } from './server.mjs';
import { u as useColorMode, _ as _sfc_main$4, b as _sfc_main$2$1, a as _sfc_main$1$1 } from './Main-DmrC9lpa.mjs';
import { g as getDefaultExportFromCjs } from '../_/shared.cjs.prod.mjs';
import { o as vueExports, d as ssrRenderAttrs_1, f as ssrRenderComponent_1, i as ssrRenderSlot_1, e as ssrRenderClass_1, j as ssrRenderStyle_1, b as ssrRenderAttr_1, a as ssrInterpolate_1, g as ssrRenderList_1 } from '../routes/renderer.mjs';
...
function usePortfolio(slug, themeOverride, options) {
  ...
  const { data: layoutBlocksData } = useAsyncData(
    ...
    () => options?.skipBlocks ? Promise.resolve({ blocks: [] }) : $fetch(`/api/portfolios/${slug}/pages/home/blocks`, { baseURL })
  );
...
//# sourceMappingURL=usePortfolio-CK_RoBPh.mjs.map
