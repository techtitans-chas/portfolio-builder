import { _ as __nuxt_component_0 } from './PageWrapper-upc4w-Lq.mjs';
import { _ as _sfc_main$g, d as _sfc_main$2$2, f as isValueEqualOrExist, b as AccordionRoot_default, a as AccordionItem_default, c as AccordionTrigger_default, A as AccordionContent_default, e as injectAccordionRootContext, i as injectAccordionItemContext } from './Tooltip-B9bIxuPZ.mjs';
import { W as onBeforeRouteLeave, c as __nuxt_component_2$1$1, j as _sfc_main$d$1, e as _sfc_main$8$1, ay as useState, d as _export_sfc, at as useRequestHeaders, ac as useComponentProps, a8 as useAppConfig, ak as useForwardProps, $ as reactivePick, ai as useFormField, a5 as tv, b as Primitive, aj as useForwardExpose, aB as useVModel, Q as isNullish, P as Presence_default, aa as useCollection, C as get, l as createContext, ao as useMounted } from './server.mjs';
import { _ as _sfc_main$j } from './Modal-BBL-Wwu5.mjs';
import { L as Label_default, _ as _sfc_main$k } from './FormField-Bwoy2x8u.mjs';
import { _ as _sfc_main$i } from './Input-B_IU2Xmo.mjs';
import { b as _sfc_main$2$1, a as _sfc_main$1$1, _ as __nuxt_component_11, V as VisuallyHiddenInput_default } from './MediaPickerModal-DP0Tm-L3.mjs';
import { _ as _sfc_main$l } from './Separator-Bd9m4VAI.mjs';
import { _ as _sfc_main$m } from './Alert-CsIjDkc0.mjs';
import { u as useApi } from './useApi-KjbfWxXr.mjs';
import { _ as __nuxt_component_4$1 } from './ConfirmModal-C3jTAYcv.mjs';
import { l as lo } from '../_/vue-draggable-plus.mjs';
import { u as useCurrentUser } from './useCurrentUser-0x7hmjnh.mjs';
import { _ as _sfc_main$h, R as RovingFocusItem_default } from './Tabs-Hm0ZQwst.mjs';
import { u as usePageEditor, a as allBlockDefinitions, _ as __nuxt_component_3$2, g as getPath, s as setPath, b as blockDefinitions } from './Renderer-Czl07ndm.mjs';
import { u as useCollections } from './useCollections-Be_EdGTg.mjs';
import { a as _sfc_main$1$2, u as useFormControl, c as clamp } from './MediaGrid-DqbzX4T2.mjs';
import { u as useActivePalette, c as useLayoutSettings, d as usePortfolio, p as portfolioSlugKey, _ as __nuxt_component_0$1, e as useThemes, b as MAX_CONTENT_WIDTH_OPTIONS, i as inlineEditorKey } from './usePortfolio-CK_RoBPh.mjs';
import { u as useDirection, f as useSize } from './PopperArrow-CVyIWJ6M.mjs';
import { o as vueExports, f as ssrRenderComponent_1, d as ssrRenderAttrs_1, j as ssrRenderStyle_1, a as ssrInterpolate_1, g as ssrRenderList_1, e as ssrRenderClass_1, b as ssrRenderAttr_1, s as ssrIncludeBooleanAttr, m as ssrRenderVNode, i as ssrRenderSlot_1 } from '../routes/renderer.mjs';
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.8.0_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_0c4e5d558bbbd0ce3bc597d918a8198d/node_modules/@nuxt/ui/dist/runtime/components/Accordion.vue");
...
const __nuxt_component_7 = Object.assign(_sfc_main$9, { __name: "PagebuilderLeftSidebar" });
...
const _sfc_main$7 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    vueExports.watch(selectedBlock, async (block) => {
      ...
      if (!blockEl) return;
      const canvas = blockEl.closest(".overflow-auto");
      if (!canvas) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_PortfolioLayout, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative min-h-64" data-v-7b5a847c${_scopeId}>`);
            if (vueExports.unref(localBlocks).length === 0) {
              _push2(`<div class="absolute inset-0 flex flex-col items-center justify-center gap-3 py-24 text-center pointer-events-none select-none z-10" data-v-7b5a847c${_scopeId}>`);
              _push2(ssrRenderComponent_1(_component_UIcon, {
                name: "i-lucide-layout-template",
                class: "size-10 text-muted opacity-40"
              }, null, _parent2, _scopeId));
              _push2(`<p class="text-sm text-muted opacity-60" data-v-7b5a847c${_scopeId}> Drag a block here<br data-v-7b5a847c${_scopeId}> to start building </p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent_1(vueExports.unref(lo), {
              ...
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList_1(vueExports.unref(localBlocks), (block) => {
                    _push3(`<div class="${ssrRenderClass_1([isSelected(block) ? "block-selected" : "block-hoverable", "group/block relative min-h-16 after:absolute after:inset-0 after:pointer-events-none after:transition-[outline] after:duration-150 after:outline-2 after:-outline-offset-2"])}" data-v-7b5a847c${_scopeId2}><div class="block-drag-handle w-8 h-8 flex justify-center items-center absolute top-2 left-1/2 -translate-x-1/2 z-10 cursor-grab active:cursor-grabbing opacity-0 group-hover/block:opacity-100 transition-opacity bg-black/50 rounded p-1" data-v-7b5a847c${_scopeId2}>`);
                    _push3(ssrRenderComponent_1(_component_UIcon, {
                      name: "i-lucide-grip-horizontal",
                      class: "size-4 text-white"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div class="absolute top-2 right-2 z-10 flex gap-1 opacity-0 group-hover/block:opacity-100 transition-opacity" data-v-7b5a847c${_scopeId2}><button class="w-7 h-7 flex items-center justify-center bg-black/50 hover:bg-black/70 rounded" title="Duplicate block" data-v-7b5a847c${_scopeId2}>`);
                    _push3(ssrRenderComponent_1(_component_UIcon, {
                      name: "i-lucide-copy",
                      class: "size-3.5 text-white"
                    }, null, _parent3, _scopeId2));
                    _push3(`</button><button class="w-7 h-7 flex items-center justify-center bg-black/50 hover:bg-red-600 rounded" title="Delete block" data-v-7b5a847c${_scopeId2}>`);
                    _push3(ssrRenderComponent_1(_component_UIcon, {
...
const __nuxt_component_9 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-7b5a847c"]]), { __name: "PagebuilderPreview" });
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.8.0_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_0c4e5d558bbbd0ce3bc597d918a8198d/node_modules/@nuxt/ui/dist/runtime/components/Checkbox.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.8.0_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_0c4e5d558bbbd0ce3bc597d918a8198d/node_modules/@nuxt/ui/dist/runtime/components/Slider.vue");
...
const __nuxt_component_10 = Object.assign(_sfc_main$1, { __name: "PagebuilderRightSidebar" });
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const publishing = vueExports.ref(false);
    const isPublished = vueExports.computed(() => portfolio.value?.isPublished ?? false);
    async function togglePublish() {
      ...
      try {
        ...
        portfolio.value.publishedAt = newValue ? (/* @__PURE__ */ new Date()).toISOString() : portfolio.value.publishedAt;
      } finally {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_USwitch = _sfc_main$2$1;
      const _component_UButton = _sfc_main$8$1;
      const _component_PagebuilderLeftSidebar = __nuxt_component_7;
      const _component_ClientOnly = __nuxt_component_2$1$1;
      const _component_PagebuilderPreview = __nuxt_component_9;
      const _component_PagebuilderRightSidebar = __nuxt_component_10;
      _push(ssrRenderComponent_1(_component_AdminLayoutPageWrapper, vueExports.mergeProps({ title: "" }, _attrs), {
        ...
        right: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent_1(_component_USwitch, {
              "model-value": vueExports.unref(isPublished),
              loading: vueExports.unref(publishing),
              color: "neutral",
              label: "Publish site",
              class: "mr-2",
              "onUpdate:modelValue": togglePublish
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent_1(_component_UButton, {
              color: "neutral",
              variant: vueExports.unref(isDirty) ? "solid" : "outline",
              "aria-label": "Save",
            ...
            return [
              ...
              vueExports.createVNode(_component_UButton, {
                ...
                disabled: !vueExports.unref(isDirty) && !vueExports.unref(saving),
                onClick: save
              }, null, 8, ["variant", "label", "icon", "loading", "disabled"]),
...
//# sourceMappingURL=index-5QRFw9df.mjs.map
