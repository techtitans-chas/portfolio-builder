import { ae as tryOnBeforeUnmount, q as createSharedComposable, ah as unrefElement, r as defaultWindow, aM as useVModel, X as onKeyStroke, o as createGlobalState, az as useMounted, aO as vueExports$1, an as useComponentProps, aj as useAppConfig, av as useForwardProps$1, $ as reactivePick, aB as usePortal, ag as tv, ac as ssrRenderVNode, a7 as ssrRenderComponent_1, a9 as ssrRenderSlot_1, F as FieldGroupReset, V as VisuallyHidden_default, a3 as ssrInterpolate_1, a6 as ssrRenderClass_1 } from './server.mjs';
import { g as vueExports, v as vue } from '../routes/renderer.mjs';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emits = __emit;
    const slots = vueExports$1.useSlots();
    ...
    const portalProps = usePortal(vueExports$1.toRef(() => props.portal));
    const contentProps = vueExports$1.toRef(() => props.content);
    const contentEvents = vueExports$1.computed(() => {
    ...
    const ui = vueExports$1.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.drawer || {} })({
      direction: props.direction,
      inset: props.inset,
      snapPoints: props.snapPoints && props.snapPoints.length > 0
    }));
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, vueExports$1.createVNode(vueExports$1.resolveDynamicComponent(vueExports$1.unref(props).nested ? vueExports$1.unref(_t) : vueExports$1.unref(St)), vueExports$1.mergeProps(vueExports$1.unref(rootProps), _attrs), {
        default: vueExports$1.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!!slots.default) {
              _push2(ssrRenderComponent_1(vueExports$1.unref(DialogTrigger_default), {
                "as-child": "",
                class: vueExports$1.unref(props).class
              }, {
                default: vueExports$1.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      vueExports$1.renderSlot(_ctx.$slots, "default")
                    ];
                  }
                }),
                _: 3
            ...
            _push2(ssrRenderComponent_1(vueExports$1.unref(DialogPortal_default), vueExports$1.unref(portalProps), {
              default: vueExports$1.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent_1(vueExports$1.unref(FieldGroupReset), null, {
                    default: vueExports$1.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (vueExports$1.unref(props).overlay) {
                          _push4(ssrRenderComponent_1(vueExports$1.unref(Bt), {
                            "data-slot": "overlay",
                            class: ui.value.overlay({ class: vueExports$1.unref(props).ui?.overlay })
                          }, null, _parent4, _scopeId3));
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(ssrRenderComponent_1(vueExports$1.unref(Ct), vueExports$1.mergeProps({
                          "data-slot": "content",
                          class: ui.value.content({ class: [!slots.default && vueExports$1.unref(props).class, vueExports$1.unref(props).ui?.content] })
                        }, contentProps.value, vueExports$1.toHandlers(contentEvents.value)), {
                          default: vueExports$1.withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (vueExports$1.unref(props).handle) {
                                _push5(ssrRenderComponent_1(vueExports$1.unref(Nt), {
                                  "data-slot": "handle",
                                  class: ui.value.handle({ class: vueExports$1.unref(props).ui?.handle })
                                }, null, _parent5, _scopeId4));
                              } else {
                                _push5(`<!---->`);
                              }
                              if (!vueExports$1.unref(props).title && !slots.title || !vueExports$1.unref(props).description && !slots.description || !!slots.content) {
                                _push5(ssrRenderComponent_1(vueExports$1.unref(VisuallyHidden_default), null, {
                                  default: vueExports$1.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      if (!vueExports$1.unref(props).title && !slots.title) {
                                        _push6(ssrRenderComponent_1(vueExports$1.unref(DialogTitle_default), null, null, _parent6, _scopeId5));
                                      } else if (!!slots.content) {
                                        _push6(ssrRenderComponent_1(vueExports$1.unref(DialogTitle_default), null, {
                                          default: vueExports$1.withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ssrRenderSlot_1(_ctx.$slots, "title", {}, () => {
                                                _push7(`${ssrInterpolate_1(vueExports$1.unref(props).title)}`);
                                              }, _push7, _parent7, _scopeId6);
                                            } else {
                                              return [
                                                vueExports$1.renderSlot(_ctx.$slots, "title", {}, () => [
                                                  vueExports$1.createTextVNode(vueExports$1.toDisplayString(vueExports$1.unref(props).title), 1)
                                                ])
                                              ];
                                            }
                                          }),
                                      ...
                                      if (!vueExports$1.unref(props).description && !slots.description) {
                                        _push6(ssrRenderComponent_1(vueExports$1.unref(DialogDescription_default), null, null, _parent6, _scopeId5));
                                      } else if (!!slots.content) {
                                        _push6(ssrRenderComponent_1(vueExports$1.unref(DialogDescription_default), null, {
                                          default: vueExports$1.withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ssrRenderSlot_1(_ctx.$slots, "description", {}, () => {
                                                _push7(`${ssrInterpolate_1(vueExports$1.unref(props).description)}`);
                                              }, _push7, _parent7, _scopeId6);
                                            } else {
                                              return [
                                                vueExports$1.renderSlot(_ctx.$slots, "description", {}, () => [
                                                  vueExports$1.createTextVNode(vueExports$1.toDisplayString(vueExports$1.unref(props).description), 1)
                                                ])
                                              ];
                                            }
                                          }),
                                      ...
                                      return [
                                        !vueExports$1.unref(props).title && !slots.title ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTitle_default), { key: 0 })) : !!slots.content ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTitle_default), { key: 1 }, {
                                        ...
                                        !vueExports$1.unref(props).description && !slots.description ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogDescription_default), { key: 2 })) : !!slots.content ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogDescription_default), { key: 3 }, {
                                          default: vueExports$1.withCtx(() => [
                                            vueExports$1.renderSlot(_ctx.$slots, "description", {}, () => [
                                              vueExports$1.createTextVNode(vueExports$1.toDisplayString(vueExports$1.unref(props).description), 1)
                                            ])
                              ...
                              ssrRenderSlot_1(_ctx.$slots, "content", {}, () => {
                                _push5(`<div data-slot="container" class="${ssrRenderClass_1(ui.value.container({ class: vueExports$1.unref(props).ui?.container }))}"${_scopeId4}>`);
                                if (!!slots.header || (vueExports$1.unref(props).title || !!slots.title) || (vueExports$1.unref(props).description || !!slots.description)) {
                                  _push5(`<div data-slot="header" class="${ssrRenderClass_1(ui.value.header({ class: vueExports$1.unref(props).ui?.header }))}"${_scopeId4}>`);
                                  ssrRenderSlot_1(_ctx.$slots, "header", {}, () => {
                                    if (vueExports$1.unref(props).title || !!slots.title) {
                                      _push5(ssrRenderComponent_1(vueExports$1.unref(DialogTitle_default), {
                                        "data-slot": "title",
                                        class: ui.value.title({ class: vueExports$1.unref(props).ui?.title })
                                      }, {
                                        default: vueExports$1.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                          if (_push6) {
                                            ssrRenderSlot_1(_ctx.$slots, "title", {}, () => {
                                              _push6(`${ssrInterpolate_1(vueExports$1.unref(props).title)}`);
                                    ...
                                    if (vueExports$1.unref(props).description || !!slots.description) {
                                      _push5(ssrRenderComponent_1(vueExports$1.unref(DialogDescription_default), {
                                        "data-slot": "description",
                                        class: ui.value.description({ class: vueExports$1.unref(props).ui?.description })
                                      }, {
                                        default: vueExports$1.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                          if (_push6) {
                                            ssrRenderSlot_1(_ctx.$slots, "description", {}, () => {
                                              _push6(`${ssrInterpolate_1(vueExports$1.unref(props).description)}`);
                                            }, _push6, _parent6, _scopeId5);
                                          } else {
                                            return [
                                              vueExports$1.renderSlot(_ctx.$slots, "description", {}, () => [
                                ...
                                if (!!slots.body) {
                                  _push5(`<div data-slot="body" class="${ssrRenderClass_1(ui.value.body({ class: vueExports$1.unref(props).ui?.body }))}"${_scopeId4}>`);
                                ...
                                if (!!slots.footer) {
                                  _push5(`<div data-slot="footer" class="${ssrRenderClass_1(ui.value.footer({ class: vueExports$1.unref(props).ui?.footer }))}"${_scopeId4}>`);
                              ...
                              return [
                                vueExports$1.unref(props).handle ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(Nt), {
                                  key: 0,
                                  "data-slot": "handle",
                                  class: ui.value.handle({ class: vueExports$1.unref(props).ui?.handle })
                                }, null, 8, ["class"])) : vueExports$1.createCommentVNode("", true),
                                !vueExports$1.unref(props).title && !slots.title || !vueExports$1.unref(props).description && !slots.description || !!slots.content ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(VisuallyHidden_default), { key: 1 }, {
                                  default: vueExports$1.withCtx(() => [
                                    !vueExports$1.unref(props).title && !slots.title ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTitle_default), { key: 0 })) : !!slots.content ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTitle_default), { key: 1 }, {
                                      default: vueExports$1.withCtx(() => [
                                        vueExports$1.renderSlot(_ctx.$slots, "title", {}, () => [
                                ...
                                vueExports$1.renderSlot(_ctx.$slots, "content", {}, () => [
                                  vueExports$1.createVNode("div", {
                                    "data-slot": "container",
                                    class: ui.value.container({ class: vueExports$1.unref(props).ui?.container })
                                  }, [
                                    !!slots.header || (vueExports$1.unref(props).title || !!slots.title) || (vueExports$1.unref(props).description || !!slots.description) ? (vueExports$1.openBlock(), vueExports$1.createBlock("div", {
                                      key: 0,
                                      "data-slot": "header",
                                      class: ui.value.header({ class: vueExports$1.unref(props).ui?.header })
                                    }, [
                                      vueExports$1.renderSlot(_ctx.$slots, "header", {}, () => [
                                        vueExports$1.unref(props).title || !!slots.title ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTitle_default), {
                                          key: 0,
                                          "data-slot": "title",
                                          class: ui.value.title({ class: vueExports$1.unref(props).ui?.title })
                                        }, {
                                          ...
                                          _: 3
                                        }, 8, ["class"])) : vueExports$1.createCommentVNode("", true),
                                        vueExports$1.unref(props).description || !!slots.description ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogDescription_default), {
                                          key: 1,
                                          "data-slot": "description",
                                          class: ui.value.description({ class: vueExports$1.unref(props).ui?.description })
                                        }, {
                                    ...
                                    ], 2)) : vueExports$1.createCommentVNode("", true),
                                    !!slots.body ? (vueExports$1.openBlock(), vueExports$1.createBlock("div", {
                                      key: 1,
                                      "data-slot": "body",
                                      class: ui.value.body({ class: vueExports$1.unref(props).ui?.body })
                                    }, [
                                      vueExports$1.renderSlot(_ctx.$slots, "body")
                                    ], 2)) : vueExports$1.createCommentVNode("", true),
                                    !!slots.footer ? (vueExports$1.openBlock(), vueExports$1.createBlock("div", {
                                      key: 2,
                                      "data-slot": "footer",
                                      class: ui.value.footer({ class: vueExports$1.unref(props).ui?.footer })
                                    }, [
                                      vueExports$1.renderSlot(_ctx.$slots, "footer")
                                    ], 2)) : vueExports$1.createCommentVNode("", true)
                                  ], 2)
                                ])
                              ];
                        ...
                        return [
                          vueExports$1.unref(props).overlay ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(Bt), {
                            key: 0,
                            "data-slot": "overlay",
                            class: ui.value.overlay({ class: vueExports$1.unref(props).ui?.overlay })
                          }, null, 8, ["class"])) : vueExports$1.createCommentVNode("", true),
                          vueExports$1.createVNode(vueExports$1.unref(Ct), vueExports$1.mergeProps({
                            "data-slot": "content",
                            class: ui.value.content({ class: [!slots.default && vueExports$1.unref(props).class, vueExports$1.unref(props).ui?.content] })
                          }, contentProps.value, vueExports$1.toHandlers(contentEvents.value)), {
                            default: vueExports$1.withCtx(() => [
                  ...
                  return [
                    vueExports$1.createVNode(vueExports$1.unref(FieldGroupReset), null, {
                      default: vueExports$1.withCtx(() => [
                        vueExports$1.unref(props).overlay ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(Bt), {
                          key: 0,
                          "data-slot": "overlay",
            ...
            return [
              !!slots.default ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(DialogTrigger_default), {
                key: 0,
                "as-child": "",
                class: vueExports$1.unref(props).class
              }, {
              ...
              vueExports$1.createVNode(vueExports$1.unref(DialogPortal_default), vueExports$1.unref(portalProps), {
                default: vueExports$1.withCtx(() => [
                  vueExports$1.createVNode(vueExports$1.unref(FieldGroupReset), null, {
                    default: vueExports$1.withCtx(() => [
                      vueExports$1.unref(props).overlay ? (vueExports$1.openBlock(), vueExports$1.createBlock(vueExports$1.unref(Bt), {
