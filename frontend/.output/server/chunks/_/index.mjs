...
var Editor = class extends Editor$1 {
  constructor(options = {}) {
    ...
    return vueExports.markRaw(this);
  }
  get state() {
...
var EditorContent = vueExports.defineComponent({
  name: "EditorContent",
  props: {
    editor: {
      default: null,
    ...
    vueExports.watchEffect(() => {
      ...
      if (editor && editor.options.element && rootEl.value) {
        vueExports.nextTick(() => {
          ...
          const element = vueExports.unref(rootEl.value);
...
var useEditor = (options = {}) => {
  const editor = vueExports.shallowRef();
    ...
    appendTransaction: (transactions, oldState, newState) => {
      ...
      changes.forEach(({ newRange }) => {
        ...
        if (textBlock && textBeforeWhitespace) {
          ...
          const linksBeforeSpace = tokenize_1(lastWordBeforeSpace).map(
  ...
  return new Plugin({
    ...
    props: {
      handlePaste: (view, _event, slice) => {
        ...
        const link = find_1(textContent, { defaultProtocol: options.defaultProtocol }).find(
  ...
  onCreate() {
    ...
    this.options.protocols.forEach((protocol) => {
      if (typeof protocol === "string") {
        registerCustomProtocol_1(protocol);
        return;
      }
      registerCustomProtocol_1(protocol.scheme, protocol.optionalSlashes);
    });
  },
  onDestroy() {
    reset_1();
      ...
      markPasteRule({
        find: (text) => {
          ...
          if (text) {
            ...
            const links = find_1(text).filter(
...
export { EditorContent as E, index_default$1 as a, index_default as b, index_default$2 as i, useEditor as u };
