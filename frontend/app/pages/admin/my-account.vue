      ...
      <UPageBody>
        ...
        <div class="max-w-md space-y-3 mb-8">
          ...
          <div class="flex items-center gap-4">
            <div class="w-20 h-20 rounded-full overflow-hidden bg-muted border flex items-center justify-center shrink-0">
              <img
                v-if="displayedImage"
                :src="displayedImage"
                alt="Profile image"
          ...
          <Transition name="fade">
            <div v-if="showDefaultPicker" class="grid grid-cols-6 gap-2 pt-1">
              <button
                ...
                :class="displayedImage === path ? 'border-primary' : 'border-transparent hover:border-muted-foreground'"
                :disabled="uploadingAvatar"
